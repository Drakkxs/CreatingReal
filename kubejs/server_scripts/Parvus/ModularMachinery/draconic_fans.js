...
(() => {
    ...
    /**
     * Constructs and returns an object representing a machine builder for Draconic Fans.
    ...
    /** The Draconic Fan */
    let draconicFAN = machBuilder("mmr:draconic_fan", "create:encased_fan");
    ...
    MMREvents.machines(event => {
        ...
        /** All types of draconic fans */
        draconicFAN.machineType.forEach((_, typeKey) => {
            draconicFAN.buildMACH(event, typeKey);
        })
    })
    
    ServerEvents.recipes(event => {

        draconicFAN.machineType.forEach((type, typeKey) => {
            ...
            event.shaped(
                ...
                {
                    a: draconicFAN.traitItem, // The defining trait of the draconic fan.
                    c: type.gateItem || draconicFAN.traitItem, // A item that will be used as a gate
                    b: [].concat(type.coreItem, draconicFAN.parseBlocktoItems(type.coreBlock, typeKey)).filter(a => a),  //arg 3: the mapping object
                }
            )
